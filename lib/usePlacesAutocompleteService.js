...
function usePlacesAutocompleteService(_ref) {
  var apiKey = _ref.apiKey,
    ...
    googleMapsScriptBaseUrl =
      _ref$googleMapsScript === void 0
        ? _constants.GOOGLE_MAP_SCRIPT_BASE_URL
        : _ref$googleMapsScript,
  ...
  var googleMapsScriptUrl = ""
    .concat(googleMapsScriptBaseUrl, "?key=")
    .concat(apiKey, "&libraries=")
    .concat(libraries)
    .concat(languageQueryParam);
  ...
  var handleLoadScript = (0, _react.useCallback)(
    function () {
      return (0, _utils.loadGoogleMapScript)(
        googleMapsScriptBaseUrl,
        googleMapsScriptUrl
      );
    },
  ...
  var debouncedPlacePredictions = (0, _react.useCallback)(
    (0, _lodash.default)(function (optionsArg) {
  ...
  var debouncedQueryPredictions = (0, _react.useCallback)(
    (0, _lodash.default)(function (optionsArg) {
      if (placesAutocompleteService.current && optionsArg.input)
    ...
    var buildService = function buildService() {
      ...
      if (typeof google !== "undefined") {
        ...
        placesAutocompleteService.current =
          new google.maps.places.AutocompleteService(); // eslint-disable-next-line no-undef
