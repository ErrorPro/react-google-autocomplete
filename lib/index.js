...
var ReactGoogleAutocomplete = (function (_React$Component) {
  ...
  function ReactGoogleAutocomplete(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        ReactGoogleAutocomplete.__proto__ ||
        Object.getPrototypeOf(ReactGoogleAutocomplete)
      ).call(this, props)
    );

    _this.handleLoadScript = function () {
      var googleMapsScriptUrl =
      ...
      if (
        document.querySelectorAll('script[src="' + googleMapsScriptUrl + '"]')
          .length > 0
      ) {
  ...
  _createClass(ReactGoogleAutocomplete, [
    {
      ...
      value: function componentDidMount() {
        ...
        var _props = this.props,
          ...
          types = _props$types === undefined ? [] : _props$types,
        ...
        var handleAutoComplete = function handleAutoComplete() {
          _this2.autocomplete = new google.maps.places.Autocomplete(
            _this2.refs.input,
            config
          );

          _this2.event = _this2.autocomplete.addListener(
            "place_changed",
            _this2.onSelected.bind(_this2)
          );
        };
        ...
        if (window.MutationObserver) {
          var observerHack = new MutationObserver(function () {
            ...
            if (_this3.refs && _this3.refs.input) {
              _this3.refs.input.autocomplete =
                _this3.props.inputAutocompleteValue || "new-password";
            }
          });
...
var ReactCustomGoogleAutocomplete = (exports.ReactCustomGoogleAutocomplete = (function (
  _React$Component2
) {
  ...
  function ReactCustomGoogleAutocomplete(props) {
    ...
    var _this4 = _possibleConstructorReturn(
      this,
      (
        ReactCustomGoogleAutocomplete.__proto__ ||
        Object.getPrototypeOf(ReactCustomGoogleAutocomplete)
      ).call(this, props)
    );
      ...
      value: function onChange(e) {
        ...
        if (e.target.value) {
          this.service.getPlacePredictions(
            { input: e.target.value, types: types },
