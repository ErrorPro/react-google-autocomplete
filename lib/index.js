  ...
  _createClass(ReactGoogleAutocomplete, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          types = _props2.types,
          autoplaceholder = _props2.autoplaceholder,
          componentRestrictions = _props2.componentRestrictions,
          bounds = _props2.bounds,
          rest = _objectWithoutProperties(_props2, ['onPlaceSelected', 'types', 'autoplaceholder', 'componentRestrictions', 'bounds']);
...
ReactGoogleAutocomplete.propTypes = {
  ...
  autoplaceholder: _propTypes2.default.string,
